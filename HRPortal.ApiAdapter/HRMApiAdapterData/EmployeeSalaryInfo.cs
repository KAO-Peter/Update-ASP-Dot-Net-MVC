...
namespace HRPortal.ApiAdapter.HRMApiAdapterData
{
    public class EmployeeSalaryInfo
    {
        ...
        public double PaidTotal { get; set; } //已發金額
        public string LanguageCookie { get; set; } //20190524 Daniel 增加語系
        public string EmpEnglishName { get; set; } //英文姓名
        public string DeptEnglishName { get; set; } //部門英文名稱
        public string JobTitleEnglishName { get; set; } //英文職稱
    }

    public class EmployeeSalaryInfoDDMC
    {
        public string Name { get; set; }
        public string EmpID { get; set; }
        public string Sex { get; set; }
