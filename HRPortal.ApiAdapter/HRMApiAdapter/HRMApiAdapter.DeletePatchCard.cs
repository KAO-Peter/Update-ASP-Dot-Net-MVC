...
namespace HRPortal.ApiAdapter
{
    ...
    {
        public static async Task<DeleteResponse> DeletePatchCard(string companyCode, string empId, string formNo)
        {
            ...
            string _uri = new Uri(new Uri(_hostUri), _postDeletePatchCardUri).ToString();
