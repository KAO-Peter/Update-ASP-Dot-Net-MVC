...
namespace HRPortal.ApiAdapter
{
    ...
    {
        public static async Task<RequestResult> PostDuty_FEDS(string companyCode, string empId, DateTime time,
            int type, int reasonType, string reason = "")
        {
            ...
            string _uri = new Uri(new Uri(_hostUri), _postDutyUri_FEDS).ToString();
