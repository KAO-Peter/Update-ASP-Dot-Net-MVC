...
namespace HRPortal.ApiAdapter
{
    ...
    {
        public static async Task<RequestResult> PostDutyAddFormNo(string formNo, string companyCode, string empId, DateTime time,
            int type, int reasonType, string reason = "")
        {
            ...
            string _uri = new Uri(new Uri(_hostUri), _postDutyAddFormNoUri).ToString();
