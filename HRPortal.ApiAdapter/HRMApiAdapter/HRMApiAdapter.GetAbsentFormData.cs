...
namespace HRPortal.ApiAdapter
{
    public partial class HRMApiAdapter
    {
        ...
        /// <returns></returns>
        public static async Task<List<AbsentFormData>> GetAbsentFormData(string companyCode, string empID, string deptCode,string StatusData, DateTime? startTime, DateTime? endTime, string LanguageCookie="zh-TW")
        {
            string _uri = new Uri(new Uri(_hostUri), _getAbsentFormDataUri).ToString();
