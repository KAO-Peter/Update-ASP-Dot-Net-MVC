...
namespace HRPortal.ApiAdapter
{
    ...
    {
        public static async Task<DeleteResponse> CheckDeleteOverTime(string companyCode, string empId, string formNo)
        {
            string _uri = new Uri(new Uri(_hostUri), _checkDeleteOverTimeUri).ToString();
