...
namespace HRPortal.ApiAdapter
{
    public partial class HRMApiAdapter
    {
        ...
        /// <returns></returns>
        public static async Task<List<SalaryFormNo>> GetEmployeeSalaryFormNoFEDS(string companyCode, string empId, DateTime? beginMonth, DateTime? endMonth)
        {
            string _uri = new Uri(new Uri(_hostUri), _getSalaryFormNoFEDS).ToString();
