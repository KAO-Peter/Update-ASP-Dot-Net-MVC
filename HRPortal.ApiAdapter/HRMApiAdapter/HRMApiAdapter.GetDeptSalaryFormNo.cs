...
namespace HRPortal.ApiAdapter
{
    public partial class HRMApiAdapter
    {
        ...
        /// <returns></returns>
        public static async Task<List<SalaryFormNo>> GetDeptSalaryFormNo(string companyCode, DateTime? beginMonth, DateTime? endMonth)
        {
            string _uri = new Uri(new Uri(_hostUri), _getDeptSalaryFormNo).ToString();
