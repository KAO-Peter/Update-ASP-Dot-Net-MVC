...
namespace HRPortal.ApiAdapter
{
    ...
    {
        public static async Task<GetEmpDataCasual> GetEmpDataCasual(string companyCode, string deptCode, string empID = "", string empName = "", string idNumber = "", int page = 1, int pageSize = 10)
        {
            string _uri = new Uri(new Uri(_hostUri), _getEmpDataCasualUri).ToString();
