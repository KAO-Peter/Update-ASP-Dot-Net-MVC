...
namespace HRPortal.ApiAdapter
{
    ...
    {
        public static async Task<DeleteResponse> DeleteLeave(string companyCode, string empId, string formNo)
        {
            ...
            string _uri = new Uri(new Uri(_hostUri), _postDeleteLeaveUri).ToString();
