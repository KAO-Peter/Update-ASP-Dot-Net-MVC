...
namespace HRPortal.SignFlow.Conditions
{
    ...
    public class OverTimeCdCheck : ConditionCheck
	{
		public OverTimeCdCheck()
		{
		}

        public OverTimeCdCheck(string DesignID)
        {
            this.DesignID = DesignID;
        }
        
        public OverTimeCdCheck(string DesignID, string ChkLevel)
		{
            this.DesignID = DesignID;
